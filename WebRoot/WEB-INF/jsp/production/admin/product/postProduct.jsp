		...
		<table>
			...
			<tr>
				...
				<td height='200'><textarea id="introductionPrddWysiwyg"
						style="width:900px;height:200px" name="introductionPrdd">${productDetailDTO.introductionPrdd}</textarea></td>
			</tr>
			<tr>
				<td width='60'>产品参数</td>
				<td height='200'><textarea id="parametersPrddWysiwyg"
						style="width:900px;height:200px" name="parametersPrdd">${productDetailDTO.parametersPrdd}</textarea></td>
			</tr>
			<tr>
				<td width='60'>产品特性</td>
				<td height='200'><textarea id="featuresPrddWysiwyg"
						style="width:900px;height:200px" name="featuresPrdd">${productDetailDTO.featuresPrdd}</textarea></td>
			</tr>
			<tr>
				<td width='60'>供货商</td>
				<td height='100'><textarea id="supplierPrdddWysiwyg"
						style="width:900px;height:100px" name="supplierPrdd">${productDetailDTO.supplierPrdd}</textarea></td>
			</tr>
			<tr>
				<td width='60'>产品列表页显示图片</td>
				<td><input name="logo" type="FILE" id="logo" size="50" />  ${productDetailDTO.productDTO.logoName}  </td>
			</tr>
			<tr>
				<td width='60'>产品页面第一张大图</td>
