...
<body>
	...
	<FORM class="form-horizontal" name="form1" METHOD="POST"
		ACTION="newsAdmin.do?action=save" ENCTYPE="multipart/form-data">
		<input name="id" type="hidden" value="${newsDto.idN}" />
		<table>
			<tr>
				<td width='60'>标题</td>
				<td ><input name="titleN" type="text" style="width:900px;height:30px"
					value="${newsDto.titleN}" /></td>
			</tr>
			<tr>
				<td width='60'>内容</td>
				<td height='400'><textarea id="wysiwyg" style="width:900px;height:600px"
						name="contentN" >${newsDto.contentN}</textarea></td>
			</tr>
			<tr>
				<td width='60'>图片</td>
				<td ><input name="FILE" type="FILE" id="file"
					size="50" /> ${newsDto.picName}</td>
			</tr>
