...
public class UploadFileUtil {
	...
	public static String getFileDirectoryPath(HttpServletRequest request, String sourceDirectory){
		...
		if(!StringUtils.isBlank(KnxConfig.FILE_SOURCE_DIRECTORY)){
			fileDirectory = KnxConfig.FILE_SOURCE_DIRECTORY + sourceDirectory + "/" + dateSubDirectory + "/";
		}
	...
	public static String getContentPath(Content content) {
		...
		return KnxConfig.STATIC_URL + content.getFilepathCon();
	}
	
	public static String getContentAbsolutePath(HttpServletRequest request, Content content) {
		if (content == null) {
			return null;
		}		
		String path = request.getRealPath("") + "/ul/" + content.getFilepathCon();
		if(!StringUtils.isBlank(KnxConfig.FILE_SOURCE_DIRECTORY)){
			path = KnxConfig.FILE_SOURCE_DIRECTORY + content.getFilepathCon();
		}
		return path;
	}
